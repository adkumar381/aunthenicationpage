    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 h-screen w-full">
        ...
        <div className="bg-gray-400 flex flex-col justify-center">
            <form className='max-w-[400px] w-full mx-auto bg-gray-900 p-8 px-8 rounded-lg'>
                <h2 className="text-4x1 dark : text-white font-bold text-lg text-center" >Sign IN</h2>
                ...
                <div className="flex justify-between text-gray-400 py-2">
                    <p className="flex items-center"><input className="mr-2" type="checkbox"/>Don't Forget</p>
                    <p>Forget Password</p>
                </div>
